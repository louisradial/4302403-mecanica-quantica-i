\begin{exercício}{Potencial delta de Dirac}{exercício3}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Qual a probabilidade \(\overline{\dl{\mathcal{P}(p)}}\) de medir o momento da partícula entre \(p\) e \(p + \dl{p}\) em um dos estados estacionários normalizados calculados acima? Para que valor de \(p\) essa probabilidade é máxima? \todo[Em que domínio \(\Delta p\) é importante?] Calcule a ordem de grandeza de \(\Delta x \Delta p\).
    \end{enumerate}
\end{exercício}
